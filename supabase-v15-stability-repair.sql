-- AQUADESK V15 STABILITY REPAIR
-- Run this after the existing AquaDesk migrations.
-- Safe migration: does not delete operational event/participant data.
--
-- Fixes:
-- 1. event_winners ON CONFLICT(event_id,placement)
-- 2. winner compatibility columns
-- 3. public_site_content.key compatibility
-- 4. profile_directory 404
-- 5. user_activity_sessions upsert key
-- 6. can_view_event/is_authorised helpers
-- 7. assign_authorized_event return-type mismatch
